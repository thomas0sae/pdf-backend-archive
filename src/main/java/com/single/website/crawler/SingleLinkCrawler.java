 ...
 */
public class SingleLinkCrawler
{
        ...
        if (!links.contains(URL) && URL.contains(rootURL)) {
            try {
                ...
                for (Element page : linksOnPage) {
                    ...
                    System.out.println("hreaf URI "+uri);
    ...
    public static void main(String[] args) throws IOException {
        String fn = "https://github.com/tpn/pdfs";
        ...
        rootURL = fn;
        new SingleLinkCrawler().getPageLinks(fn, fn);
