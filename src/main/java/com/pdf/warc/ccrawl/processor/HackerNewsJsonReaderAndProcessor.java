...
public class HackerNewsJsonReaderAndProcessor {
    ...
    private static JsonReader readEachJsonLine(String[] args) throws IOException {
        ...
        if (args != null && args.length > 0) {
            ...
            jsonFileName = "hacker-news-no-duplicates.json";
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            postProcessedPDFRecordForUI.setTitle(response.getLinkText());
    ...
    private static File downloadAndProcessPDF(String fileToDownload, File file) throws IOException {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty("Origin", "http://pdfdomain.com - The largest collection of PDFs from the web! Opt out at copyright@pdfdomain.com");
            httpURLConnection.setRequestProperty("Accept-Language", "en-US,en;q=0.8");
            httpURLConnection.setRequestProperty("Cache-Control", "max-age=0");
            httpURLConnection.setRequestProperty("Accept", "*/*");
            httpURLConnection.setRequestProperty("connection", "keep-alive");
            httpURLConnection.setRequestProperty("Host", "http://pdfdomain.com - The largest collection of PDFs from the web! Opt out at copyright@pdfdomain.com");
            httpURLConnection.setRequestProperty("Referer", "http://pdfdomain.com - The largest collection of PDFs from the web! Opt out at copyright@pdfdomain.com");
            httpURLConnection.setRequestProperty("X-Requested-With", "XMLHttpRequest");
            httpURLConnection.setRequestProperty("User-Agent", "http://pdfdomain.com - The largest collection of PDFs from the web! Opt out at copyright@pdfdomain.com");
